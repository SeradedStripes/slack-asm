...
run_rsa_tests:
    ...
    ; big_mod_pow with exponent 1: should return base mod modulus
    lea rdi, [rel e_limbs]
    xor eax, eax
    mov ecx, 64
    cld
    ...
    ; big_mod_pow with exponent 1 should give b mod m
    ; Verify by converting back to BE and checking first bytes match padded_buf
    lea rdi, [rel output_be]
    lea rsi, [rel r_limbs]
    mov edx, 256
    call le_to_be

    ; Compare output_be with padded_buf (should match for exponent 1)
    lea rsi, [rel output_be]
    lea rdi, [rel padded_buf]
    mov ecx, 16
    cld
    repe cmpsb
    jnz .fail
